...
# Your unit tests
assert remove_duplicates_set('accout') == 'acout'
assert remove_duplicates_set('doggie') == 'dogie'
...
assert gem_counting('abbptk', 'bk') == 3
assert gem_counting('tTyWaNM', 'puOOv') == 0
"""
...
# Your unit tests
assert students_id('005', '006', '011', '016', '009', '008', '008') == 7
assert students_id('006', '006', '006', '004', '005', '008', '001', '016', '011') == 9
...
# Your unit tests
assert students_id('005', '006', '011', '016', '009', '008', '008') == {'005' : 1, '006' : 1, '011' : 1, '016' : 1, "009" : 1, '008' : 2}
assert students_id('006', '006', '006', '005', '005', '008', '001', '001', '001') == {'006' : 3, '005' : 2, '008' :1, '001' : 3}
...
# Your unit tests
assert word_frequency ('I love my girl. I do love her.') == {'I' : 2, 'love' : 2, 'my' : 1, "girl" : 1, "do" : 1, "her" : 1}
assert word_frequency ('is there any candy? Yes there is some candy there.') == {'is' : 2, 'there': 3, 'any': 1, 'candy' : 2, "Yes" : 1, 'some' : 1}
