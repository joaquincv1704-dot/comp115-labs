...
print(f"The area of a circle of radious 2 is {area}")
...
day_today= int(input('enter what number of day today:'))
days_trip= int(input('enter the days of the trip:'))
day_back= (day_today + days_trip) % 7
print(f'Your trip starts on {day_today} and lasts {days_trip}. You are back on day {day_back}')
